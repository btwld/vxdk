...
//     /**
//      * This is only for typings. Do not use.
//      */
...
//       dependencyInjector?: (arg1: Player) => void,
//     );
...
//     interface TimelineRegionAddedEvent
//       extends CustomEvent<extern.TimelineRegionInfo> {
//       type: 'timelineregionadded';
//     }

//     /** Fired when the playhead enters a timeline region. */

//     interface TimelineRegionEnterEvent
//       extends CustomEvent<extern.TimelineRegionInfo> {
...
//     interface TimelineRegionExitEvent
//       extends CustomEvent<extern.TimelineRegionInfo> {
...
//       extends util.FakeEventTarget
//       implements util.IDestroyable
//     {
//       constructor(
//         onProgressUpdated?: (
//           duration: number,
//           transferredByteAmount: number,
//         ) => void,
//       );
...
//       static makeRequest(
//         uris: Array<string>,
//         retryParams: extern.RetryParameters,
//       ): extern.Request;
...
//     class AbortableOperation<T, A = any>
//       implements extern.IAbortableOperation<T>
//     {
//       promise: Promise<T>;
...
//       static all(
//         operations: AbortableOperation<any>[],
...
//       abort(): ReturnType<
//         ConstructorParameters<typeof util.AbortableOperation>['1']
//       >;
...
//     type GetSegmentReferenceFunction = (
//       number: number,
...
//         networkEngine: net.NetworkingEngine;
...
//       start(
//         uri: string,
//         playerInterface: ManifestParser.PlayerInterface,
//       ): Promise<Manifest>;
//       stop(): Promise<any>;
//       update(): void;
//     }
